...
// MockBatteryLimitController is a mock of BatteryLimitController interface.
type MockBatteryLimitController struct {
	ctrl     *gomock.Controller
	recorder *MockBatteryLimitControllerMockRecorder
	isgomock struct{}
}

// MockBatteryLimitControllerMockRecorder is the mock recorder for MockBatteryLimitController.
type MockBatteryLimitControllerMockRecorder struct {
	mock *MockBatteryLimitController
}

// NewMockBatteryLimitController creates a new mock instance.
func NewMockBatteryLimitController(ctrl *gomock.Controller) *MockBatteryLimitController {
	mock := &MockBatteryLimitController{ctrl: ctrl}
	mock.recorder = &MockBatteryLimitControllerMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockBatteryLimitController) EXPECT() *MockBatteryLimitControllerMockRecorder {
	return m.recorder
}

// SetChargeLimit mocks base method.
func (m *MockBatteryLimitController) SetChargeLimit(power int) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SetChargeLimit", power)
	ret0, _ := ret[0].(error)
	return ret0
}

// SetChargeLimit indicates an expected call of SetChargeLimit.
func (mr *MockBatteryLimitControllerMockRecorder) SetChargeLimit(power any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetChargeLimit", reflect.TypeOf((*MockBatteryLimitController)(nil).SetChargeLimit), power)
}

// SetDischargeLimit mocks base method.
func (m *MockBatteryLimitController) SetDischargeLimit(power int) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SetDischargeLimit", power)
	ret0, _ := ret[0].(error)
	return ret0
}

// SetDischargeLimit indicates an expected call of SetDischargeLimit.
func (mr *MockBatteryLimitControllerMockRecorder) SetDischargeLimit(power any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetDischargeLimit", reflect.TypeOf((*MockBatteryLimitController)(nil).SetDischargeLimit), power)
}
